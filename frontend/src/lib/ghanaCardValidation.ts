/**
 * Ghana Card (National ID) number criteria — format must match NIA-issued numbers.
 * @see National Identification Authority (Ghana) — card number is typically GHA-XXXXXXXXX-X (9 digits + check digit).
 */

...
import { useAuth, ROLE_DASHBOARD, isUserRestricted } from '@/contexts/AuthContext';
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <Link to={ROLE_DASHBOARD[role]} className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">{ROLE_LABELS[role]} · SmartLand</p>
              </div>
            </Link>
            <NotificationCenter />
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 p-4 rounded-xl bg-primary text-primary-foreground shadow-sm">
